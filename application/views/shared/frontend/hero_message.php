    ...
    <div class="col-12 hero-text-image">
      <div class="row">
        ...
        <div class="col-lg-5 iphone-wrap">
          <img src="<?php echo base_url('') ; ?>public/assets/img/phone_1.png" alt="Image" class="phone-1" data-aos="fade-right">
          <img src="<?php echo base_url('') ; ?>public/assets/img/phone_2.png" alt="Image" class="phone-2" data-aos="fade-right" data-aos-delay="200">
        </div>
      </div>
    </div>
  </div>
